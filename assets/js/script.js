...
const displayFiveDay = function (location) {
  ...
  fetch(fiveDayUrl).then(function (response) {
    response.json().then(function (fiveDay) {
      ...
      tempOne.innerHTML =
        "Temp: " + convertTemp(fiveDay.list[0].main.temp).toFixed(2) + " F°";
      tempTwo.innerHTML =
        "Temp: " + convertTemp(fiveDay.list[8].main.temp).toFixed(2) + " F°";
      tempThree.innerHTML =
        "Temp: " + convertTemp(fiveDay.list[16].main.temp).toFixed(2) + " F°";
      tempFour.innerHTML =
        "Temp: " + convertTemp(fiveDay.list[24].main.temp).toFixed(2) + " F°";
      tempFive.innerHTML =
        "Temp: " + convertTemp(fiveDay.list[32].main.temp).toFixed(2) + " F°";

      windOne.innerHTML =
        "Wind: " + convertWind(fiveDay.list[0].wind.speed).toFixed(2) + " mph";
      windTwo.innerHTML =
        "Wind: " + convertWind(fiveDay.list[8].wind.speed).toFixed(2) + " mph";
      windThree.innerHTML =
        "Wind: " + convertWind(fiveDay.list[16].wind.speed).toFixed(2) + " mph";
      windFour.innerHTML =
        "Wind: " + convertWind(fiveDay.list[24].wind.speed).toFixed(2) + " mph";
      windFive.innerHTML =
        "Wind: " + convertWind(fiveDay.list[32].wind.speed).toFixed(2) + " mph";

      humidOne.innerHTML =
        "Humidity: " + fiveDay.list[0].main.humidity.toFixed(0) + "%";
      humidTwo.innerHTML =
        "Humidity: " + fiveDay.list[8].main.humidity.toFixed(0) + "%";
      humidThree.innerHTML =
        "Humidity: " + fiveDay.list[16].main.humidity.toFixed(0) + "%";
      humidFour.innerHTML =
        "Humidity: " + fiveDay.list[24].main.humidity.toFixed(0) + "%";
      humidFive.innerHTML =
        "Humidity: " + fiveDay.list[32].main.humidity.toFixed(0) + "%";

      iconOne.innerHTML =
        '<img src="http://openweathermap.org/img/wn/' +
        fiveDay.list[0].weather[0].icon +
        '.png" />' +
        fiveDay.list[0].weather[0].description;
      iconTwo.innerHTML =
        '<img src="http://openweathermap.org/img/wn/' +
      ...
      iconThree.innerHTML =
        '<img src="http://openweathermap.org/img/wn/' +
        fiveDay.list[16].weather[0].icon +
        '.png" />' +
        fiveDay.list[16].weather[0].description;
      iconFour.innerHTML =
        '<img src="http://openweathermap.org/img/wn/' +
        fiveDay.list[24].weather[0].icon +
        '.png" />' +
        fiveDay.list[24].weather[0].description;
      iconFive.innerHTML =
        '<img src="http://openweathermap.org/img/wn/' +
        fiveDay.list[32].weather[0].icon +
        '.png" />' +
        fiveDay.list[32].weather[0].description;
  ...
  fetch(apiUrl).then(function (response) {
    response.json().then(function (data) {
      ...
      cityTempEl.innerHTML =
        "Temp: " + convertTemp(data.main.temp).toFixed(2) + " F°";
